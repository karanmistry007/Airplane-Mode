...
scheduler_events = {
    "sent_rent_reminders": {
        "0 12 * * *": [
            "airplane_mode.airport_shop_management.doctype.airport_shop_rent.airport_shop_rent.send_rent_reminder"
        ],
    }
    # 	"all": [
...
fixtures = [
    {"dt": "Role", "filters": None},
    {"dt": "Custom DocPerm", "filters": None},
]
